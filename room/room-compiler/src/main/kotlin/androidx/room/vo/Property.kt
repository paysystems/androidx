...
data class Property(
    ...
    // null here means that this property does not belong to parent, instead, it belongs to an
    // embedded child of the main Pojo
    val parent: EmbeddedProperty? = null,
    ...
    // binds the property into a statement
    var statementBinder: StatementValueBinder? = null

    // reads this property from a cursor column
    ...
    private val pathWithDotNotation: String by lazy {
        if (parent == null) {
            ...
            "${parent.property.pathWithDotNotation}.$name"
        }
    }
    ...
    companion object {
        fun calcNonNull(type: XType, parent: EmbeddedProperty?): Boolean {
